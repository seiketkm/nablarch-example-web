...
SELECT
    ...
    FORMAT(PROJECT.PROJECT_START_DATE, 'yyyyMMdd') AS PROJECT_START_DATE,
    FORMAT(PROJECT.PROJECT_END_DATE, 'yyyyMMdd') AS PROJECT_END_DATE,
    PROJECT.CLIENT_NUM,
    ...
    CLIENT.CLIENT_NAME
FROM
    PROJECT INNER JOIN CLIENT ON PROJECT.CLIENT_NUM = CLIENT.CLIENT_NUM
WHERE
    PROJECT.USER_NUM = :userNum
    AND $if(clientNum)     {PROJECT.CLIENT_NUM = :clientNum}
